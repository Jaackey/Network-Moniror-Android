...
//    }
    ...
    public static void updateUsedPercent(Context context) {
        if (smallWindow != null) {
            TextView percentView = (TextView) smallWindow.findViewById(R.id.percent);
            percentView.setText(getNetworkType(context));
        }
    }
...
//    private static ConnectivityManager getActiveNetworkInfo(Context context) {
//        if (connectivityManager == null) {
////            mActivityManager = (ConnectivityManager) context.getSystemService(Context.CONNECTIVITY_SERVICE);
...
//    public static boolean getTrafficFlow(Context context){
//        FloatActivity.trafficLast = TrafficStats.getTotalRxBytes()+TrafficStats.getTotalTxBytes();
